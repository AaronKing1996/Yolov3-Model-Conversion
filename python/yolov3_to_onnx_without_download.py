...
def main():
    ...
    parser.add_argument('cfg_path', help="yolov3.cfg file path", nargs='?', default="../yolov3/yolov3.cfg")
    parser.add_argument('weights_path', help="yolov3.weights file path", nargs='?', default="../yolov3/yolov3.weights")
    parser.add_argument('output_path', help="yolov3.onnx file path", nargs='?', default="../models/yolov3.onnx")
    ...
    weights_file_path = args.weights_path
