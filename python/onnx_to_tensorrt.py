...
def main():
    ...
    parser.add_argument('output_path', help="yolov3.cfg file path", nargs='?', default="../models/yolov3.trt")
    parser.add_argument('onnx_path', help="yolov3.onnx file path", nargs='?', default="../models/yolov3.onnx")
    args = parser.parse_args()

    # Try to load a previously generated YOLOv3-608 network graph in ONNX format:
    onnx_file_path = args.onnx_path
    engine_file_path = args.output_path
